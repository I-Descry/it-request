            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900 dark:text-gray-100">
                    ...
                    <div style="margin-bottom: 10px; display: flex; align-items: center; gap: 12px;">
                        <a href="{{ route('tickets.show', $ticket->ticket_no) }}" style="color: var(--text-light); text-decoration: none; font-size: 0.85rem; font-weight: 500; display: inline-flex; align-items: center; gap: 4px;">
...
<style>
                    ...
                    <form action="{{ route('tickets.update', $ticket->ticket_no) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="t-section">
                            ...
                            <div class="t-grid t-grid-2">
                                ...
                                <div>
                                    <label for="remarks" class="t-label">Remarks <span style="color: var(--text-muted); font-weight:400;">(optional)</span></label>
                        ...
                        <div class="t-section">
                            ...
                            <div>
                                <label for="attachments" class="t-label">Upload Additional Files <span style="color: var(--text-muted); font-weight:400;">(optional)</span></label>
                                <div class="t-drop">
